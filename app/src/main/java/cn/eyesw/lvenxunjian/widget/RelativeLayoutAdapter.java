 ...
 * 适配相对布局
 */
public class RelativeLayoutAdapter extends RelativeLayout {
    ...
    public RelativeLayoutAdapter(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RelativeLayoutAdapter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void addView(View child, ViewGroup.LayoutParams params) {
        if (!isInEditMode()) {
            transformSize(child, (RelativeLayout.LayoutParams) params);
        }
        super.addView(child, params);
    }

    private void transformSize(View child, RelativeLayout.LayoutParams params) {
