 ...
 * 适配约束布局
 */
public class ConstraintLayoutAdapter extends ConstraintLayout {
    ...
    public ConstraintLayoutAdapter(Context context) {
        this(context, null);
    }

    public ConstraintLayoutAdapter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ConstraintLayoutAdapter(Context context, AttributeSet attrs, int defStyle) {
