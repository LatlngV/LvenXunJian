...
public class FrameLayoutAdapter extends FrameLayout {
    ...
    public FrameLayoutAdapter(@NonNull Context context) {
        super(context);
    }

    public FrameLayoutAdapter(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FrameLayoutAdapter(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void addView(View child, ViewGroup.LayoutParams params) {
        if (!isInEditMode()) {
            transformSize(child, (FrameLayout.LayoutParams) params);
        }
        super.addView(child, params);
    }

    private void transformSize(View child, FrameLayout.LayoutParams params) {
